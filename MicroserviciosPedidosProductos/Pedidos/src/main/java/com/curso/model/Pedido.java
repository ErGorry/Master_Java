...
public class Pedido {
	...
	public String toString() {
		return "Pedido [idPedido=" + idPedido + ", comprador=" + comprador + ", nombreProducto=" + nombreProducto
				+ ", unidades=" + unidades + ", fechaPedido=" + fechaPedido + ", precioTotal=" + precioTotal + "]";
	}
